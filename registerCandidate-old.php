...
require_once 'include/dbconnect.php';
	...
	if($data['EmpID'] != '' && $isExternal == 0)
	{
		...
		$query = "INSERT INTO candidate_registration (EmpName, Skills, AdditionalSkills , EmailId , StartDate, ContactNo, Expereince, RelevantExperience, isExternal , CreatedDate, CreatedBy,candidate_image ) VALUES ('$emp_name', '$skills','$addSkill' ,'$email_id' , '$start_date', '$contact_no', '$expereince', '$relevant_experience', '$isExternal', '$created_date', '$created_by','$candidateImage')";
